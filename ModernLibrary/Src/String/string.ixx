...
export namespace dast {
	...
	template <traits::value_traits ValueTraits = traits::value_traits::no_residue, template<class, class> class StringCore = string_core>
	using cstring = basic_string<traits::string_traits<char, ValueTraits, strutil<char, std::allocator<char>>>, StringCore>;
	template <traits::value_traits ValueTraits = traits::value_traits::no_residue, template<class, class> class StringCore = string_core>
	using wstring = basic_string<traits::string_traits<wchar_t, ValueTraits, strutil<wchar_t, std::allocator<wchar_t>>>, StringCore>;
}
