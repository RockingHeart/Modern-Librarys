...
export namespace dast {
	template <character_type CharType, traits::string_value_trait ValueTraits = traits::string_value_trait::no_residue, template<class, class> class StringCore = string_core>
	using string = basic_string<traits::string_traits<CharType, ValueTraits, strutil, std::allocator<CharType>>, StringCore>;

	using cstring = basic_string<traits::string_traits<char,    traits::string_value_trait::no_residue, strutil, std::allocator<char>>,    string_core>;
	using wstring = basic_string<traits::string_traits<wchar_t, traits::string_value_trait::no_residue, strutil, std::allocator<wchar_t>>, string_core>;
}
